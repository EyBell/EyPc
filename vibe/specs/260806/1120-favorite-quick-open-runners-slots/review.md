...
> 2026-08-07 后续：本评审之外的口头整体评价另有六条产品决定，已规范化为后继增量 [260807/1740-favorite-runner-console-sync-and-args/spec.md](../../260807/1740-favorite-runner-console-sync-and-args/spec.md#L1)。其中「快开数字键绑定的是学习后的结果位置」这一质疑经用户裁决为**按现状保留、不改**；R-4 的 Linux 终端风险因系统终端降为逃生舱而降级为常规验收项。
