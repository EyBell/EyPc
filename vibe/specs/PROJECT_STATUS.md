...
- Current main line: Port management redesign for relevance search, user-defined groups and folders, command-soul editing semantics, layered shortcut profiles, settings-page shortcut governance, uTools/EzClipboard-style compact settings layout, dynamic feature tab maintenance, real process scan/kill fallback, legacy search-history compatibility without an interaction surface, compact top-right help hints, group/folder metadata deletion, and unified port focus behavior.
- Current task: Port focus and history removal removes search-history UI/runtime/keybinding commands, keeps legacy history state inert for compatibility, lets group-search highlighted rows trigger normal group commands, keeps port result/group row focus mutually exclusive, clears stale row highlights when commands move focus into port search inputs, and constrains Shift preview to active group-pane logical focus. Scope is tracked in [2606191608-eypc-port-focus-history-removal/01-spec.md](2606191608-eypc-port-focus-history-removal/01-spec.md#L1), with verification in [2606191608-eypc-port-focus-history-removal/04-verify.md](2606191608-eypc-port-focus-history-removal/04-verify.md#L1).
