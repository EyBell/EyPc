...
- Current requirement: RAW-116–121. `task-state-v3` carries activity and Turn provenance, keeps v2/legacy sources as degraded atomic packages, and never clears tasks solely for revision skew.
...
- Verification: Bridge `34/34`; status-focused Controller/Domain/platform contracts, typecheck, preload syntax and canonical/public mirror pass. The broader Codex matrix is `138/164`; the remaining 26 failures are pre-existing appearance, environment and historical UI-contract debt, not task-state failures.
...
- MQTT: [current sync](2606231645-eypc-mqtt-websocket-tab/06-sync-doc.md#L1).
...
| MQTT workbench | [sync](2606231645-eypc-mqtt-websocket-tab/06-sync-doc.md#L1) | Task-owned |
