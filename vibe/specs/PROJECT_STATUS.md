...
- Current main line: Port management redesign plus quick-open file favorites and MQTT over WebSocket quick connection: relevance search, user-defined port groups/folders, command-soul editing semantics, layered shortcut profiles, settings-page shortcut governance, dynamic feature tab maintenance, real process scan/kill fallback, compact help hints, metadata-only deletion, unified focus behavior, favorites virtual containers, explicit target initialization, target quick-open, uTools quick favorite entry, MQTT config/session/message archive, per-config record sync isolation, and lazy MQTT runtime loading.
- Current task: MQTT tab adds an isolated quick-connect workbench for WebSocket brokers: default-visible `MQTT` feature tab at default feature order 3, disabled-route fallback to Settings, main-entry route restore in [../../src/runtime/feature/featureRouting.ts](../../src/runtime/feature/featureRouting.ts#L26), lazy page/archive/client loading, editable connection configs with blank endpoint port auto-assembled as `8083`, reconnect/timeout/keepalive behavior, local-only password/token cache excluded from uTools sync, syncable or memory-only message records, three-column MQTT workbench in [../../src/pages/MqttPage.vue](../../src/pages/MqttPage.vue#L211), uTools main-window three-column breakpoint in [../../src/styles/app.css](../../src/styles/app.css#L2432), left-drawer runtime logs in [../../src/pages/MqttPage.vue](../../src/pages/MqttPage.vue#L622), runtime subscription notes/unread filters in [../../src/runtime/appRuntime.ts](../../src/runtime/appRuntime.ts#L502), publish templates/history management, configurable MQTT shortcut profile, record rename/delete/archive, and resend-to-draft behavior. Scope is tracked in [2606231645-eypc-mqtt-websocket-tab/01-spec.md](2606231645-eypc-mqtt-websocket-tab/01-spec.md#L1), with verification in [2606231645-eypc-mqtt-websocket-tab/04-verify.md](2606231645-eypc-mqtt-websocket-tab/04-verify.md#L1). The prior file management task remains tracked in [2606201810-eypc-file-management-tab/01-spec.md](2606201810-eypc-file-management-tab/01-spec.md#L1).
