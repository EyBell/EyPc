...
16. Two Chromium windows on different Spaces activate only through the selected CG window's unique Space; an unbound multi-window process returns `space-unbound-multiwindow` without fronting the other window.
