...
source_annotations: "implementation-landed / focused-automated-verified / artifact-ready / host-verified-inbound / desktop-repaint-on-focus / host-verified-native-and-host-pin / claude-cursor-pin-inbound-only / pin-lane-interface / host-verified-codex-bidirectional-pin / host-verified-cursor-wal-inbound / cursor-workspace-wal-pin-cache"
scoped_relations:
  - kind: refines
