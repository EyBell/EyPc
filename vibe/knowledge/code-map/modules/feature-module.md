...
| [actions.ts](../../../../src/runtime/feature/ports/actions.ts#L1) | 该 Tab 前缀的 `register` / `registerHandler`；实现仍闭包同一份 Runtime state。mqtt / windows / Codex 另贡献 `onTabEnter`；ports / mqtt / favorites 另贡献 `focusSearch` |
...
- **动作按包登记，实现仍在 Runtime 闭包**。[appRuntime.ts](../../../../src/runtime/appRuntime.ts#L8906) 的 `registerActions` 只组袋子并调用各包。切 Tab 与全局搜焦点已分别迁到 `onTabEnter` / `focusSearch`。DOM 对焦旁路见 [feature-action-extract](../../../specs/260904/feature-action-extract/task-card.md#L1) 第 4 刀。
