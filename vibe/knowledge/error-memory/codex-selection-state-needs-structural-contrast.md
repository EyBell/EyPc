...
| 2026-08-28 | 多选识别度转独立任务 | 用户验收：本项仍不达标，其余三项视觉记录同轮结案 | 无——本轮未再尝试修改 | 建立暂停态任务 [multiselect-recognition](../../specs/260828/multiselect-recognition/raw-requirement.md#L1) 承接，待用户补充具体不满环节后恢复 | candidate；已有明确 owner，不再由逾期复核滚动顺延 |
