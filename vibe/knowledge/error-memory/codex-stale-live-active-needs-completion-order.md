...
- Status: `candidate` for the RAW-130 cross-source waterline; prior snapshot/exit routes remain regression-verified, while the new contract and real preload-reloaded host acceptance are pending.
