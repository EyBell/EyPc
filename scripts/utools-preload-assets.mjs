...
export const UTOOLS_PRELOAD_MODULE_GROUPS = Object.freeze([
  {
    id: 'codex',
    directory: 'codex',
    files: ['action-authorization.cjs', 'action-runtime-projection.cjs', 'activity-public-projection.cjs', 'archive-bridge.cjs', 'codexhost-discovery.cjs', 'command-validation.cjs', 'desktop-activity-aggregation.cjs', 'desktop-activity-resolution.cjs', 'desktop-ipc-endpoint.cjs', 'desktop-launch.cjs', 'desktop-process-probe.cjs', 'desktop-request-projection.cjs', 'desktop-shadow.cjs', 'environment-bridge.cjs', 'environment-toml.cjs', 'float-bridge.cjs', 'float-window-size.cjs', 'inventory-thread-topology.cjs', 'inventory-turn-fields.cjs', 'launch-path-preference.cjs', 'native-registry.cjs', 'native-state-paths.cjs', 'node-runtime.cjs', 'log-redaction.cjs', 'log-stream.cjs', 'launch-plan.cjs', 'proxy-discovery.cjs', 'quota-sanitizer.cjs', 'rollout-evidence.cjs', 'rollout-runtime-state.cjs', 'run-database.cjs', 'runner-bounds.cjs', 'side-relation-hints.cjs', 'subagent-discovery.cjs', 'waiting-evidence.cjs']
  },
  {
    id: 'companion',
    directory: 'companion',
