...
export const UTOOLS_PRELOAD_MODULE_GROUPS = Object.freeze([
  {
    id: 'codex',
    directory: 'codex',
    files: ['action-authorization.cjs', 'command-validation.cjs', 'desktop-request-projection.cjs', 'environment-toml.cjs', 'inventory-thread-topology.cjs', 'inventory-turn-fields.cjs', 'node-runtime.cjs', 'log-redaction.cjs', 'log-stream.cjs', 'launch-plan.cjs', 'proxy-discovery.cjs', 'quota-sanitizer.cjs', 'rollout-evidence.cjs', 'run-database.cjs', 'runner-bounds.cjs']
  },
  {
    id: 'companion',
    directory: 'companion',
