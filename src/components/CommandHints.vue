...
<template>
  <div class="command-hints">
    ...
    <span v-else-if="snapshot.confirm">cr 确认 · esc 取消</span>
    ...
    <span v-else-if="snapshot.state.activeTab === 'ports' && snapshot.activePortPane === 'groups'">↑↓ 选组/夹 · ←→ 折叠/进入 · cr 筛选 · del/backspace 删除 · c-del 强删 · {{ label('app.hide', 's-esc') }} 隐藏</span>
