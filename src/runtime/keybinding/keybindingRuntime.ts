...
export const DEFAULT_SHORTCUT_PROFILES_BY_COMMAND = {
  ...
  'mqtt.publish.options.open': { title: '编辑 MQTT 发送选项', group: 'MQTT', layer: 'mqtt-publish-editor', shortcutIds: ['Ctrl+Shift+O'], when: "tab == 'mqtt' && activeInputRole == 'mqtt-publish-editor'", weight: 430, profileId: 'mqtt' },
  ...
  'mqtt.publish.template.send': { title: '直接发送 MQTT 模板', group: 'MQTT', layer: 'mqtt', shortcutIds: ['Ctrl+Shift+Enter'], when: "tab == 'mqtt' && mqttTargetKind == 'publish-template' && !confirmOpen && !textInputFocused", weight: 132, risk: 'data-write', profileId: 'mqtt' },
  ...
  'mqtt.record.repeatSend': { title: '重复发送 MQTT 记录', group: 'MQTT', layer: 'mqtt', shortcutIds: ['Ctrl+Shift+Enter'], when: "tab == 'mqtt' && mqttTargetKind == 'message' && !confirmOpen && !textInputFocused", weight: 132, risk: 'data-write', profileId: 'mqtt' },
  ...
  'favorites.quick.open.4': { title: '打开快速收藏第 4 项', group: '收藏', layer: 'favorites', shortcutIds: ['Ctrl+4'], when: "tab == 'favorites' && favoriteQuickMode && !favoriteDrawerActive && !confirmOpen", weight: 170 },
  'favorites.quick.open.5': { title: '打开快速收藏第 5 项', group: '收藏', layer: 'favorites', shortcutIds: ['Ctrl+5'], when: "tab == 'favorites' && favoriteQuickMode && !favoriteDrawerActive && !confirmOpen", weight: 170 },
  'favorites.quick.open.6': { title: '打开快速收藏第 6 项', group: '收藏', layer: 'favorites', shortcutIds: ['Ctrl+6'], when: "tab == 'favorites' && favoriteQuickMode && !favoriteDrawerActive && !confirmOpen", weight: 170 },
  'favorites.quick.open.7': { title: '打开快速收藏第 7 项', group: '收藏', layer: 'favorites', shortcutIds: ['Ctrl+7'], when: "tab == 'favorites' && favoriteQuickMode && !favoriteDrawerActive && !confirmOpen", weight: 170 },
  'favorites.quick.open.8': { title: '打开快速收藏第 8 项', group: '收藏', layer: 'favorites', shortcutIds: ['Ctrl+8'], when: "tab == 'favorites' && favoriteQuickMode && !favoriteDrawerActive && !confirmOpen", weight: 170 },
  'favorites.quick.open.9': { title: '打开快速收藏第 9 项', group: '收藏', layer: 'favorites', shortcutIds: ['Ctrl+9'], when: "tab == 'favorites' && favoriteQuickMode && !favoriteDrawerActive && !confirmOpen", weight: 170 },
  'favorites.quick.open.10': { title: '打开快速收藏第 10 项', group: '收藏', layer: 'favorites', shortcutIds: ['Ctrl+0'], when: "tab == 'favorites' && favoriteQuickMode && !favoriteDrawerActive && !confirmOpen", weight: 170 }
