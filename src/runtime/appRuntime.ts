...
import { getPlatform, type FavoriteDirectoryEntry, type PickedFavorite, type PickedFavoriteKind } from '../platform/eypcPlatform'
...
export type SearchFocusTarget = 'ports' | 'port-groups' | 'favorites' | 'favorite-groups'
