...
import { DEFAULT_FEATURE_CONFIGS, type AppTabId, type FeatureConfig } from '../../domain/types'
...
export { DEFAULT_FEATURE_CONFIGS }
...
export function allFeatures(configs: readonly FeatureConfig[] = DEFAULT_FEATURE_CONFIGS): FeatureDefinition[] {
  return configs
...
export function visibleFeatures(features: readonly (FeatureDefinition | FeatureConfig)[] = DEFAULT_FEATURE_CONFIGS): VisibleFeatureDefinition[] {
