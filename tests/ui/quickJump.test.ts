...
describe('global quick jump UI wiring', () => {
  ...
  it('positions lightweight badges slightly above their targets', () => {
    ...
    expect(css).toContain('background: rgba(255, 247, 250, 0.96)')
    expect(css).toContain('border: 1px solid rgba(225, 29, 72, 0.42)')
    expect(css).toContain('box-shadow: 0 2px 7px')
